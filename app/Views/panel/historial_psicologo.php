    ...
    <div class="col-12">
        <div class="card">
            <div class="border-bottom title-part-padding">
                <h4 class="card-title mb-0 text-center">Historial de Pacientes Asignados</h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="table-historial-pacientes" class="table table-striped table-bordered" style="width:100%" cellspacing="0">
                        <thead class="text-center">
                            <tr>
                                <th class="special-cell">#</th>
                                <th class="special-cell">Identificador</th>
                                <th class="special-cell">Paciente</th>
                                <th class="special-cell">Estado asignación</th>
...
<!-- JS específico -->
<script src="<?php echo base_url(RECURSOS_PANEL_JS . "/specifics/historial_psicologo.js") ?>"></script>
<?= $this->endSection(); ?>