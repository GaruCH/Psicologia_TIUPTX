    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if ($tipo_paciente == SUBCATEGORIA_ALUMNO['clave']): ?>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="Papel" name="Papel" value="Alumno" readonly>
                ...
                <?php elseif ($tipo_paciente == 'administrativo'): ?>
                    <div class="col-md-4 mb-3">
                        <label class="form-control-label">Número de empleado:</label>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="numero_empleado" name="numero_empleado" value="<?= $usuario['numero_empleado'] ?>" readonly>
                            <label><i data-feather="user" class="feather-sm text-dark fill-white me-2"></i>Número de empleado</label>
                        </div>
                    </div>
                <?php elseif ($tipo_paciente == 'invitado'): ?>
                    <div class="col-md-4 mb-3">
                        <label class="form-control-label">ID de invitado:</label>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="id_invitado" name="id_invitado" value="<?= $usuario['id_invitado'] ?>" readonly>
                            <label><i data-feather="user" class="feather-sm text-dark fill-white me-2"></i>ID de invitado</label>
                        </div>
                    </div>
                <?php endif; ?>
