...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="card" id="loginform">
                                    <div class="card-body">
                                        ...
                                        <?= form_open('actualizar_contrasena', ['id' => 'form-reset-password', 'class' => 'form-horizontal mt-4 pt-4 needs-validation']) ?>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="password" style="color: #FFFFFF;"><i data-feather="lock" class="feather-sm text-white fill-white me-2"></i>Nueva contraseña</label>
                                        </div>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            ?>
                                            <div class="invalid-feedback"></div>
                                            <label for="passwordc" style="color: #FFFFFF;"><i data-feather="lock" class="feather-sm text-white fill-white me-2"></i>Confirmar Contraseña</label>
                                        </div>

                                        <div class="form-group text-center mt-4 mb-3">
                                            <div class="col-xs-12">
                                                <button class="btn btn-info d-block w-100 waves-effect waves-light" type="submit" style="background: #A7250D; border-color: #CC9933; color:#ffff">Restablecer Contraseña</button>
                                            </div>
                                        </div>
                                        <?= form_close() ?>
                                    </div>
    ...
    <script src="<?= base_url(RECURSOS_PANEL_JS . "/specifics/recuperar_contrasena.js") ?>"></script>
    <!-- Constants Js -->
