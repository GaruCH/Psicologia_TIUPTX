...
<body>
        ...
        <div class="row auth-wrapper gx-0">
            ...
            <div class="col-lg-9 col-xl-9 d-flex align-items-center justify-content-center" style="background:url(<?= base_url(IMG_DIR_SISTEMA . '/' . BACKGROUND_SISTEMA) ?>) no-repeat center center; background-size: cover;">
                <div class="row justify-content-center w-100 mt-4 mt-lg-0 ">
                    <div class="col-lg-5 col-xl-6 col-md-11">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-floating mb-3">
                                    <!--<input class="form-control form-input-bg" type="email" required="" placeholder="Email address"  style='background-color: #CC9933; color: #FFFFFF;'> -->
                                    <?php
                                    $parametros = array(
                                        'type' => 'email',
                                    ...
                                    <label for="tb-emailrp" style="color: #FFFFFF;"><i data-feather="at-sign" class="feather-sm text-white fill-white me-2"></i>Correo electrónico</label>

                                </div>
                                <div class="d-flex align-items-stretch button-group justify-content-center">
                                    <button type="submit" class="btn btn-info px-4" style="background: #A7250D; color:#ffff; border-color: #CC9933;">Recuperar</button>
                                    <a href="<?= route_to('login') ?>" class="btn btn-light-secondary text-secondary font-weight-medium" style="color:#542772">Cancelar</a>
                                </div>
    ...
    <script src="<?= base_url(RECURSOS_PANEL_JS . "/specifics/recover_password.js") ?>"></script>
    <!-- Constants Js -->
