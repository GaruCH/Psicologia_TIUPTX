...
<body>
    <div class="main-wrapper">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card" id="loginform">
                                    <div class="card-body">
                                        <h4 class="card-title">Registro Paciente - Administrativo (a)</h4>
                                        ...
                                        echo form_open_multipart('registrar_paciente_administrativo', $parametros);
                                        ?>
                                        ...
                                        <div id="section1">
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        ?>
                                                        <div class="invalid-feedback"></div>
                                                        <label for="fecha_nacimiento" style="color: #FFFFFF;"><i data-feather="calendar" class="feather-sm text-white fill-white me-2"></i>Fecha de Nacimiento</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        ?>
                                                        <div class="invalid-feedback"></div>
                                                        <label for="numero_trabajador" style="color: #FFFFFF;"><i data-feather="hash" class="feather-sm text-white fill-white me-2"></i>No. Trabajador</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-5 mb-3">
                                                    <label class="form-control-label">Tipo de referencia: (<font color="red">*</font>)</label>
                                                    <div class="form-floating mb-3">
                                                        <?php
                                                        $parametros = [
                                                            'class' => 'form-select',
                                                        ...
                                                        echo form_dropdown('referencia', $referencias, '', $parametros);
                                                        ?>
                                                        <div class="invalid-feedback"></div>
                                                        <label for="referencia" style="color: #FFFFFF;">
                                                            <i class="fas fa-lg fa-info-circle text-white fill-white me-2"></i>Tipo de referencia
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 mb-3">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <label for="area" style="color: #FFFFFF;">
                                                            <i class="fas fa-lg fa-info-circle text-white fill-white me-2"></i>Área
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="nextSection(2)" style="background: #A7250D; color: #FFFFFF; border-color: #CC9933;">Siguiente</button>
                                            </div>
                                        </div>
                                        ...
                                        <div id="section2" class="d-none">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-5 mb-2">
                                                    <label class="form-control-label" for="emailr">E-mail: (<font color="red">*</font>)</label>
                                                    <div class="form-floating mb-3">
                                                        <?php
                                                        $parametros = array(
                                                            'type' => 'email',
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-4 mb-3">
                                                    <label class="form-control-label" for="passwordr">Contraseña: (<font color="red">*</font>)</label>
                                                    <div class="form-floating mb-3">
                                                        <?php
                                                        $parametros = array(
                                                            'type' => 'password',
                                                        ...
                                                        ?>
                                                        <div class="invalid-feedback"></div>
                                                        <label for="passwordr" style="color: #FFFFFF;"><i data-feather="unlock" class="feather-sm text-white fill-white me-2"></i>********</label>
                                                    </div>
                                                </div>

                                                <div class="col-md-4 mb-3">
                                                    <label class="form-control-label" for="confirm_passwordr">Confirmar contraseña: (<font color="red">*</font>)</label>
                                                    <div class="form-floating mb-3">
                                                        <?php
                                                        $parametros = array(
                                                            'type' => 'password',
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <button type="button" class="btn btn-primary" onclick="prevSection(1)" style="background: #A7250D; color: #FFFFFF; border-color: #CC9933;">Anterior</button>
        ...
        <script src="<?= base_url(RECURSOS_PANEL_JS . "/specifics/register_administrativos.js") ?>"></script>
        <!-- Constants Js -->
