...
}, "El numero de trabajador debe contener exactamente 3 números.");
...
$("#formulario-paciente-nuevo").validate({
    ...
    messages: {
        ...
        area: {
            required: 'Se requiere seleccionar un área.'
        },
        emailr: {
        ...
        numero_trabajador: {
            required: 'Se requiere el numero de trabajador del paciente.',
            matriculaRegex: 'El numero de trabajador debe contener exactamente 3 números.'
        }
    }, // end messages
