...
$.validator.addMethod("matriculaRegex", function(value, element) {
    return this.optional(element) || /^[0-9]{10}$/.test(value);
}, "La matrícula debe contener exactamente 10 números.");
...
$.validator.addMethod("validDate", function(value, element) {
    ...
    return true;
}, "Ingrese una fecha de nacimiento válida y que indique al menos 12 años de edad.");
...
$("#formulario-paciente-nuevo").validate({
    ...
    messages: {
        ...
        carrera: {
            required: 'Se requiere seleccionar una carrera.'
        },
        emailr: {
        ...
        matricula: {
            required: 'Se requiere la matrícula del paciente.',
            matriculaRegex: 'La matrícula debe contener exactamente 10 números.'
        }
    }, // end messages
